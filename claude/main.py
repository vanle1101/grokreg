...
from claudereg.flow import run_batch
from claudereg.stop import clear_stop


def parse_args():
    parser = argparse.ArgumentParser(description="Claude / Anthropic Auto Register Tool")
...
def main():
    ...
    try:
        ...
        print("\n[Claude] Người dùng bấm Ctrl+C để dừng.")
