...
from zaireg.flow import run_batch
from zaireg.stop import clear_stop


def parse_args():
    parser = argparse.ArgumentParser(description="Z.ai / ZCode Auto Register & Quota Check")
...
def main():
    ...
    try:
        ...
        print("\n[Z.ai] Người dùng bấm Ctrl+C để dừng.")
